...
def get_training_parser():
    ...
    # Training
    parser.add_argument('-lr', dest='lr', default=0.001, type=float, help='Learning rate used when optimizing the parameters. Note that the alpha parameter is using a learning rate fixed at 0.1 as its importance is higher than any other individual parameter.')
